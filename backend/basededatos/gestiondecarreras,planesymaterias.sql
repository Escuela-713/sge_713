...
-- Schema sge713
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `sge713` DEFAULT CHARACTER SET latin1 ;
USE `sge713` ;

-- -----------------------------------------------------
-- Table `sge713`.`alumno`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sge713`.`alumno` (
...
-- -----------------------------------------------------
-- Table `sge713`.`alumno_x_plan`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sge713`.`alumno_x_plan` (
...
-- Table `sge713`.`cargo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sge713`.`cargo` (
...
-- Table `sge713`.`plan`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sge713`.`plan` (
  `idPlan` INT(11) NOT NULL AUTO_INCREMENT,
  `idCarrera` INT(11) NOT NULL,
  `plan` SMALLINT(4) NOT NULL,
  `estado` VARCHAR(8) NOT NULL,
  `horasCatedra` SMALLINT NOT NULL,
  `horasReloj` SMALLINT NOT NULL,
  PRIMARY KEY (`idPlan`))
ENGINE = InnoDB
AUTO_INCREMENT = 2
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
-- Table `sge713`.`carrera`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sge713`.`carrera` (
  `idCarrera` INT(11) NOT NULL AUTO_INCREMENT,
  `nombre` VARCHAR(60) NOT NULL,
  `estado` VARCHAR(8) NOT NULL,
  `tituloEgreso` VARCHAR(60) NOT NULL,
  `idPlan` INT(11) NOT NULL,
  `descripcion` VARCHAR(300) NULL,
  PRIMARY KEY (`idCarrera`, `idPlan`),
  INDEX `fk_carrera_plan1_idx` (`idPlan` ASC) VISIBLE,
  CONSTRAINT `fk_carrera_plan1`
    FOREIGN KEY (`idPlan`)
    REFERENCES `sge713`.`plan` (`idPlan`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
AUTO_INCREMENT = 13
...
-- Table `sge713`.`curso`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sge713`.`curso` (
...
-- -----------------------------------------------------
-- Table `sge713`.`empleado`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sge713`.`empleado` (
...
-- -----------------------------------------------------
-- Table `sge713`.`empleado_x_cargo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sge713`.`empleado_x_cargo` (
...
-- -----------------------------------------------------
-- Table `sge713`.`estado_civil`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sge713`.`estado_civil` (
...
-- -----------------------------------------------------
-- Table `sge713`.`instancia`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sge713`.`instancia` (
...
-- -----------------------------------------------------
-- Table `sge713`.`localidad`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sge713`.`localidad` (
...
-- -----------------------------------------------------
-- Table `sge713`.`materia`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sge713`.`materia` (
  `idMateria` INT(11) NOT NULL,
  `nombre` VARCHAR(60) NOT NULL,
  `descripcion` VARCHAR(300) NULL,
  `anio` SMALLINT(4) NOT NULL,
  `hsSemanales` SMALLINT NOT NULL,
  `hsAnual` SMALLINT NOT NULL,
  `idPlan` INT(11) NOT NULL,
  PRIMARY KEY (`idMateria`, `idPlan`),
  INDEX `fk_materia_plan1_idx` (`idPlan` ASC) VISIBLE,
  CONSTRAINT `fk_materia_plan1`
    FOREIGN KEY (`idPlan`)
    REFERENCES `sge713`.`plan` (`idPlan`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- Table `sge713`.`pais`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sge713`.`pais` (
...
-- -----------------------------------------------------
-- Table `sge713`.`persona`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sge713`.`persona` (
...
-- -----------------------------------------------------
-- Table `sge713`.`profesor_x_materia`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sge713`.`profesor_x_materia` (
...
-- -----------------------------------------------------
-- Table `sge713`.`provincia`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sge713`.`provincia` (
  ...
  CONSTRAINT `#id_pais`
    FOREIGN KEY (`id_pais`)
    REFERENCES `sge713`.`pais` (`id_pais`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
AUTO_INCREMENT = 28
...
-- -----------------------------------------------------
-- Table `sge713`.`trayectoria`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sge713`.`trayectoria` (
...
-- Table `sge713`.`tutor`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sge713`.`tutor` (
...
-- -----------------------------------------------------
-- Table `sge713`.`usuario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sge713`.`usuario` (
  ...
  CONSTRAINT `#id_usuario_persona`
    ...
    REFERENCES `sge713`.`persona` (`id_persona`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
BEGIN
INSERT INTO `sge713`.`materia_x_plan`
(`anio`,
`hs_semanales`,
`hs_anual`)
VALUES
...
BEGIN
  SELECT id_pais, nombre FROM sge713.pais ORDER BY nombre ASC;
END$$
