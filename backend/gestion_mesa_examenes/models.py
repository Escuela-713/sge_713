...
class MesasExamenes(models.Model):
    ...
    id_profesores = models.ForeignKey('Profesores', models.DO_NOTHING, db_column='id_profesores', null=True)  # Field renamed to remove unsuitable characters.
    id_materias = models.IntegerField(db_column='id_materias', null=True)  # Field renamed to remove unsuitable characters.
    id_modalidades = models.ForeignKey('Modalidades', models.DO_NOTHING, db_column='id_modalidades', null=True)  # Field renamed to remove unsuitable characters.
