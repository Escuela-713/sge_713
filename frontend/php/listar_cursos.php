			...
			<table class="table table-striped table-hover">
				...
				<tbody>	
						...
						<tr>
							...
							<td class = "text-right">
								<a href="#CursoModal" class="btn btn-info" data-target="#CursoModal" class="edit" data-toggle="modal" data-id='<?php echo $id;?>' data-anio="<?php echo $anio?>" data-division="<?php echo $division?>"  ><span class="glyphicon glyphicon-edit" ></span>Editar</a>
