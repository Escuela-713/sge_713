		...
		<div class="modal-content">
			<form name="frm_empleado" id="frm_empleado">
				<div class="modal-header">						
					<h4 id="titulo" name="titulo" class="modal-title">Agregar Nuevo Empleado</h4>
							...
							<div role="tabpanel" class="tab-pane active" id="datos_empleadotab">
									...
									<div class="form-group">
										<div class="form-row" >
											<div class="form-group col-md-6">
												<div class="form-group">
													<label>Legajo</label>
													<input type="number" name="legajo" id="legajo" class="form-control"  placeholder="Ingrese aquí el Legajo">
												</div>
											</div>
											<div class="form-group col-md-6">
												<div class="form-group">
								...
								<div role="tabpanel" class="tab-pane" id="datos_personalestab">
											...
											<div class="card">
												...
												<div id="collapseOne" class="collapse show" data-parent="#accordion">
													<div class="card-body">
														...
														<div class="form-group">
															<label>Barrio</label>
															<input type="text" name="barrio" id="barrio" class="form-control" placeholder="Ingrese aquí el Barrio" maxlength="45" >
														</div>
														<div class="form-row" >
															<div class="form-group col-md-8">
																<div class="form-group">
																	<label>Calle</label>
																	<input type="text" name="calle" id="calle" class="form-control" placeholder="Ingrese aquí la Calle" maxlength="45" >
																</div>
															</div>
															<div class="form-group col-md-4">
																<div class="form-group">
																	<label>Número</label>
																	<input type="number" name="numero" id="numero" class="form-control" placeholder="Ingrese aquí el Número" maxlength="4" >
																</div>
															</div>
														</div>
												</div>
									...
									<div class="form-group">
										...
										<input type="text" name="telefono" id="telefono" class="form-control" placeholder="Ingrese aquí el N° de Teléfono" maxlength="14" >
									</div>
								</div>
							</div>
						</div>
